...
const traerCategoria = prompt("Ingrese la categoria que desea mostrar");

const resultadoCategoria = productos.filter(
  (items) => (items.categoria === traerCategoria)
);

resultadoCategoria.forEach((items) => {
  alert(`
        Id: ${items.id}
        Nombre: ${items.nombre}
